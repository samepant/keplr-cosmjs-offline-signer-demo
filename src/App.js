...
const txMsgs = [
  {
    typeUrl: "/cosmos.bank.v1beta1.MsgSend",
    value: {
      fromAddress: "cosmos1uu3grdl3l7yxpsv3v2lqm250zruwrgsdhsnawq",
      toAddress: "cosmos1q4w6w5lrsqut6mxj49vlvz7hqclsy0tnhrz825",
      amount: [
        {
          amount: "40000000",
          denom: "stake",
...
function App() {
  ...
  const cosmjsSign = async () => {
    try {
      ...
      console.log(accounts, signingClient);
      ...
      console.log(encode(bodyBytes));
      console.log(encode(signatures[0]));
    } catch (error) {
      console.log(error);
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <button onClick={keplrSign}>
          Sign with keplr offlinse signer (logs to console)
        </button>
